...
public class PassengerManag1 extends PassengerManag1Base {
    ...
    private void checkReceivedSubscriptions() {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            ...
            else if (interaction instanceof TransferPass) {
    ...
    private void execute() throws Exception {
        ...
        while (!exitCondition) {
            ...
            //    Airline1DeparturReady airline1DeparturReady = create_Airline1DeparturReady();
            //    airline1DeparturReady.set_actualLogicalGenerationTime( < YOUR VALUE HERE > );
            //    airline1DeparturReady.set_airline( < YOUR VALUE HERE > );
            //    airline1DeparturReady.set_federateFilter( < YOUR VALUE HERE > );
            //    airline1DeparturReady.set_flightNumber( < YOUR VALUE HERE > );
            //    airline1DeparturReady.set_originFed( < YOUR VALUE HERE > );
            //    airline1DeparturReady.set_sourceFed( < YOUR VALUE HERE > );
            //    airline1DeparturReady.sendInteraction(getLRC(), currentTime + getLookAhead());
