...
public class PeopleFlowBase extends SynchronizedFederate {
    ...
    public PeopleFlowBase(FederateConfig config) throws Exception {
        ...
        // interaction pubsub
        RealtimePeopleArrival.publish(getLRC());
        DayAheadPeopleInfo.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           DayAheadPeopleInfo.get_handle(),
    ...
    public RealtimePeopleArrival create_RealtimePeopleArrival() {
        RealtimePeopleArrival interaction = new RealtimePeopleArrival();
