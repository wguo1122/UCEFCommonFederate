...
/**
* Implements InteractionRoot.C2WInteractionRoot.DepartureFlightInfo
*/
public class DepartureFlightInfo extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the DepartureFlightInfo interaction class with default parameter values.
    */
    public DepartureFlightInfo() {}

    private static int _actualLogicalGenerationTime_handle;
    private static int _depTime_handle;
    private static int _deptReq_handle;
    ...
    /**
    * Returns the handle (RTI assigned) of the DepartureFlightInfo interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the DepartureFlightInfo interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.DepartureFlightInfo";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the DepartureFlightInfo interaction class.
    *
    ...
    * DepartureFlightInfo interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo", DepartureFlightInfo.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo", _allDatamemberNames);

        _datamemberNames.add("depTime");
        _datamemberNames.add("deptReq");
        ...
        _datamemberTypeMap.put("deptReq", "String");
        ...
        _allDatamemberNames.add("deptReq");
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.DepartureFlightInfo");
        _classHandleSimpleNameMap.put(get_handle(), "DepartureFlightInfo");
        ...
        while(isNotInitialized) {
            try {
                ...
                _deptReq_handle = rti.getParameterHandle("deptReq", get_handle());
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.depTime", _depTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.deptReq", _deptReq_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.destination", _destination_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.flightNumber", _flightNumber_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.fuelLevel", _fuelLevel_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.modelNum", _modelNum_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.passengerNum", _passengerNum_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureFlightInfo.sourceFed", _sourceFed_handle);
        ...
        _datamemberHandleNameMap.put(_deptReq_handle, "deptReq");
    ...
    /**
    * Publishes the DepartureFlightInfo interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the DepartureFlightInfo interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the DepartureFlightInfo interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the DepartureFlightInfo interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the DepartureFlightInfo interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the DepartureFlightInfo interaction class).
    ...
    */
    ...
    public String getParameterName(int datamemberHandle) {
        ...
        else if (datamemberHandle == _deptReq_handle) return "deptReq";
    ...
    */
    ...
    /**
    * Set the value of the "deptReq" parameter to "value" for this parameter.
    *
    * @param value the new value for the "deptReq" parameter
    */
    public void set_deptReq( String value ) {
        _deptReq = value;
    }

    /**
    * Returns the value of the "deptReq" parameter of this interaction.
    *
    * @return the value of the "deptReq" parameter
    */
    public String get_deptReq() {
        return _deptReq;
    }
    /**
    ...
    */
    ...
    protected DepartureFlightInfo( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected DepartureFlightInfo( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the DepartureFlightInfo interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new DepartureFlightInfo interaction class instance
    */
    public DepartureFlightInfo( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #DepartureFlightInfo( ReceivedInteraction datamemberMap )}, except this
    * new DepartureFlightInfo interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new DepartureFlightInfo interaction class instance
    * @param logicalTime timestamp for this new DepartureFlightInfo interaction class
    * instance
    */
    public DepartureFlightInfo( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new DepartureFlightInfo interaction class instance that is a duplicate
    * of the instance referred to by DepartureFlightInfo_var.
    *
    * @param DepartureFlightInfo_var DepartureFlightInfo interaction class instance of which
    * this newly created DepartureFlightInfo interaction class instance will be a
    * duplicate
    */
    public DepartureFlightInfo( DepartureFlightInfo DepartureFlightInfo_var ) {
        super( DepartureFlightInfo_var );

        set_depTime( DepartureFlightInfo_var.get_depTime() );
        set_deptReq( DepartureFlightInfo_var.get_deptReq() );
        set_destination( DepartureFlightInfo_var.get_destination() );
        set_flightNumber( DepartureFlightInfo_var.get_flightNumber() );
        set_fuelLevel( DepartureFlightInfo_var.get_fuelLevel() );
        set_modelNum( DepartureFlightInfo_var.get_modelNum() );
        set_passengerNum( DepartureFlightInfo_var.get_passengerNum() );
    }
    ...
    */
    public Object getParameter( String datamemberName ) {
        ...
        else if ( "deptReq".equals(datamemberName) ) return get_deptReq();
    ...
    protected boolean setParameterAux( String datamemberName, String val ) {
        ...
        else if ( "deptReq".equals( datamemberName) ) set_deptReq( val );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        ...
        else if ( "deptReq".equals( datamemberName) ) set_deptReq( (String)val );
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof DepartureFlightInfo ) {
            DepartureFlightInfo data = (DepartureFlightInfo)object;
            _depTime = data._depTime;
            _deptReq = data._deptReq;
