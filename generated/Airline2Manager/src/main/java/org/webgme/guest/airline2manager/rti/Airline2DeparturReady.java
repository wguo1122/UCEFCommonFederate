...
/**
* Implements InteractionRoot.C2WInteractionRoot.Airline2DeparturReady
*/
public class Airline2DeparturReady extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Airline2DeparturReady interaction class with default parameter values.
    */
    public Airline2DeparturReady() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the Airline2DeparturReady interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Airline2DeparturReady interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.Airline2DeparturReady";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the Airline2DeparturReady interaction class.
    *
    * @return the name of this interaction class
    */
    public static String get_simple_class_name() {
        return "Airline2DeparturReady";
    }
    ...
    * Airline2DeparturReady interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady", Airline2DeparturReady.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Airline2DeparturReady");
        _classHandleSimpleNameMap.put(get_handle(), "Airline2DeparturReady");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.airline", _airline_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.flightNumber", _flightNumber_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Airline2DeparturReady.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the Airline2DeparturReady interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the Airline2DeparturReady interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the Airline2DeparturReady interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the Airline2DeparturReady interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the Airline2DeparturReady interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the Airline2DeparturReady interaction class).
    ...
    */
    ...
    protected Airline2DeparturReady( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected Airline2DeparturReady( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the Airline2DeparturReady interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Airline2DeparturReady interaction class instance
    */
    public Airline2DeparturReady( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #Airline2DeparturReady( ReceivedInteraction datamemberMap )}, except this
    * new Airline2DeparturReady interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Airline2DeparturReady interaction class instance
    * @param logicalTime timestamp for this new Airline2DeparturReady interaction class
    * instance
    */
    public Airline2DeparturReady( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new Airline2DeparturReady interaction class instance that is a duplicate
    * of the instance referred to by Airline2DeparturReady_var.
    *
    * @param Airline2DeparturReady_var Airline2DeparturReady interaction class instance of which
    * this newly created Airline2DeparturReady interaction class instance will be a
    * duplicate
    */
    public Airline2DeparturReady( Airline2DeparturReady Airline2DeparturReady_var ) {
        super( Airline2DeparturReady_var );

        set_airline( Airline2DeparturReady_var.get_airline() );
        set_flightNumber( Airline2DeparturReady_var.get_flightNumber() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof Airline2DeparturReady ) {
            Airline2DeparturReady data = (Airline2DeparturReady)object;
