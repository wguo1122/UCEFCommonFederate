...
public class DayaheadSchedule extends C2WInteractionRoot {
    ...
    */
    ...
    private static int _slotSchedule_handle;
    ...
    */
    ...
    static {
        ...
        _datamemberNames.add("slotSchedule");

        _datamemberTypeMap.put("slotSchedule", "String");

        _allDatamemberNames.add("actualLogicalGenerationTime");
        _allDatamemberNames.add("federateFilter");
        _allDatamemberNames.add("originFed");
        _allDatamemberNames.add("slotSchedule");
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                ...
                _slotSchedule_handle = rti.getParameterHandle("slotSchedule", get_handle());
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DayaheadSchedule.slotSchedule", _slotSchedule_handle);
        ...
        _datamemberHandleNameMap.put(_slotSchedule_handle, "slotSchedule");
    ...
    */
    ...
    public String getParameterName(int datamemberHandle) {
        ...
        else if (datamemberHandle == _slotSchedule_handle) return "slotSchedule";
    ...
    */
    ...
    public String toString() {
        return getClass().getName() + "("
                ...
                + "," + "slotSchedule:" + get_slotSchedule()
                + "," + "sourceFed:" + get_sourceFed()
                + ")";
    }

    private String _slotSchedule = "";

    /**
    * Set the value of the "slotSchedule" parameter to "value" for this parameter.
    *
    * @param value the new value for the "slotSchedule" parameter
    */
    public void set_slotSchedule( String value ) {
        _slotSchedule = value;
    }

    /**
    * Returns the value of the "slotSchedule" parameter of this interaction.
    *
    * @return the value of the "slotSchedule" parameter
    */
    public String get_slotSchedule() {
        return _slotSchedule;
    }
    ...
    */
    public DayaheadSchedule( DayaheadSchedule DayaheadSchedule_var ) {
        ...
        set_slotSchedule( DayaheadSchedule_var.get_slotSchedule() );
    }
    ...
    */
    public Object getParameter( String datamemberName ) {
        if ( "slotSchedule".equals(datamemberName) ) return get_slotSchedule();
        else return super.getParameter( datamemberName );
    }

    protected boolean setParameterAux( String datamemberName, String val ) {
        boolean retval = true;
        if ( "slotSchedule".equals( datamemberName) ) set_slotSchedule( val );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        boolean retval = true;
        if ( "slotSchedule".equals( datamemberName) ) set_slotSchedule( (String)val );
        else retval = super.setParameterAux( datamemberName, val );
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof DayaheadSchedule ) {
            ...
            _slotSchedule = data._slotSchedule;
        }
    }
}
