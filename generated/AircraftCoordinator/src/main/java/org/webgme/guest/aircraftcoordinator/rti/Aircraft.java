...
/**
* Implements InteractionRoot.C2WInteractionRoot.Aircraft
*/
public class Aircraft extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Aircraft interaction class with default parameter values.
    */
    public Aircraft() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the Aircraft interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Aircraft interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.Aircraft";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the Aircraft interaction class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.Aircraft");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Aircraft", Aircraft.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Aircraft", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Aircraft", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Aircraft");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Aircraft");
        _classHandleSimpleNameMap.put(get_handle(), "Aircraft");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.airline", _airline_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.flightNumber", _flightNumber_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Aircraft.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the Aircraft interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the Aircraft interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the Aircraft interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the Aircraft interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the Aircraft interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the Aircraft interaction class).
    ...
    */
    ...
    protected Aircraft( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected Aircraft( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the Aircraft interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Aircraft interaction class instance
    */
    public Aircraft( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #Aircraft( ReceivedInteraction datamemberMap )}, except this
    * new Aircraft interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new Aircraft interaction class instance
    * @param logicalTime timestamp for this new Aircraft interaction class
    * instance
    */
    public Aircraft( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new Aircraft interaction class instance that is a duplicate
    * of the instance referred to by Aircraft_var.
    *
    * @param Aircraft_var Aircraft interaction class instance of which
    * this newly created Aircraft interaction class instance will be a
    * duplicate
    */
    public Aircraft( Aircraft Aircraft_var ) {
        super( Aircraft_var );

        set_airline( Aircraft_var.get_airline() );
        set_flightNumber( Aircraft_var.get_flightNumber() );
    }
