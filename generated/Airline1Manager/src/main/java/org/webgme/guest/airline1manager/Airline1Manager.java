        ...
        while (!exitCondition) {
            ...
            if (currentTime%((60/timeScale)*24) == 0 ) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    dayaheadSchedule.set_capacity( Integer.valueOf(values [5]) );
                    dayaheadSchedule.set_booked( Integer.valueOf(values [6])  );
                    dayaheadSchedule.set_transfer( Integer.valueOf(values [7])  );
