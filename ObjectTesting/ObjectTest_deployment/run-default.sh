...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Analysis-${timestamp}.log -T "Analysis" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,Analysis" &
waitUntilJoined Analysis 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/FedA-${timestamp}.log -T "FedA" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,FedA" &
waitUntilJoined FedA 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/FedB-${timestamp}.log -T "FedB" -geometry 140x40+90+120 -e "mvn exec:java -P ExecJava,FedB" &
waitUntilJoined FedB 1
