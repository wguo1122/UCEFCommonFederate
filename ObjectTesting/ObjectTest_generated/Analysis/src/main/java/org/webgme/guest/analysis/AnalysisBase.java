package org.webgme.guest.analysis;

import org.webgme.guest.analysis.rti.*;
...
public class AnalysisBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public AnalysisBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        Metrics.subscribe_DataA();
        Metrics.subscribe_DataB();
        Metrics.subscribe(getLRC());
    }
