...
public class FedBBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public FedBBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // object pubsub
        Metrics.publish_DataA();
        Metrics.publish_DataB();
        Metrics.publish(getLRC());
    }
