...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/AirlineGateMan1-${timestamp}.log -T "AirlineGateMan1" -geometry 140x40+90+120 -e "mvn exec:java -P ExecJava,AirlineGateMan1" &
waitUntilJoined AirlineGateMan1 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/AirlineGateMan2-${timestamp}.log -T "AirlineGateMan2" -geometry 140x40+120+150 -e "mvn exec:java -P ExecJava,AirlineGateMan2" &
waitUntilJoined AirlineGateMan2 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/PassengerManag1-${timestamp}.log -T "PassengerManag1" -geometry 140x40+150+180 -e "mvn exec:java -P ExecJava,PassengerManag1" &
waitUntilJoined PassengerManag1 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/PassengerManag2-${timestamp}.log -T "PassengerManag2" -geometry 140x40+180+210 -e "mvn exec:java -P ExecJava,PassengerManag2" &
waitUntilJoined PassengerManag2 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/PeopleFlow-${timestamp}.log -T "PeopleFlow" -geometry 140x40+210+240 -e "mvn exec:java -P ExecJava,PeopleFlow" &
