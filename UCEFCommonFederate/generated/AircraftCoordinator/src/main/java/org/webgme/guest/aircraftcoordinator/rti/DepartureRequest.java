...
public class DepartureRequest extends C2WInteractionRoot {
    ...
    */
    ...
    protected static void init(RTIambassador rti) {
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.DepartureRequest.realTimeSchedule", _realTimeSchedule_handle);
    ...
    */
    public DepartureRequest( DepartureRequest DepartureRequest_var ) {
        ...
        set_realTimeSchedule( DepartureRequest_var.get_realTimeSchedule() );
    }
    ...
    */
    public Object getParameter( String datamemberName ) {
        if ( "realTimeSchedule".equals(datamemberName) ) return get_realTimeSchedule();
        else return super.getParameter( datamemberName );
    }

    protected boolean setParameterAux( String datamemberName, String val ) {
        boolean retval = true;
        if ( "realTimeSchedule".equals( datamemberName) ) set_realTimeSchedule( val );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        boolean retval = true;
        if ( "realTimeSchedule".equals( datamemberName) ) set_realTimeSchedule( (String)val );
        else retval = super.setParameterAux( datamemberName, val );
