...
public class PassengerManag1Base extends SynchronizedFederate {
    ...
    public PassengerManag1Base(FederateConfig config) throws Exception {
        ...
        TransferPassConfirm1.publish(getLRC());
        PM1ToPM2Realtime.publish(getLRC());
        PM1ToPM2DayAhead.publish(getLRC());
        PM2ToPM1Realtime.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           PM2ToPM1Realtime.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        ArrivalTransferPass1.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           ArrivalTransferPass1.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        ...
        _subscribedInteractionFilter.setFedFilters( 
           ...
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        PM2ToPM1DayAhead.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           PM2ToPM1DayAhead.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
    ...
    public TransferPassConfirm1 create_TransferPassConfirm1() {
        TransferPassConfirm1 interaction = new TransferPassConfirm1();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
    public PM1ToPM2Realtime create_PM1ToPM2Realtime() {
        PM1ToPM2Realtime interaction = new PM1ToPM2Realtime();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
    public PM1ToPM2DayAhead create_PM1ToPM2DayAhead() {
        PM1ToPM2DayAhead interaction = new PM1ToPM2DayAhead();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
